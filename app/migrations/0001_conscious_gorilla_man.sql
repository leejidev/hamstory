...
ALTER TABLE "notifications" ADD CONSTRAINT "notifications_layout_id_layouts_layout_id_fk" FOREIGN KEY ("layout_id") REFERENCES "public"."layouts"("layout_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
